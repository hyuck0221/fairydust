<p align="center">
  <img src="icon.png" alt="Fairydust logo" width="128">
</p>

<h1 align="center">Fairydust</h1>

<p align="center">
  Fairy 후원이 들어왔을 때 GitHub 프로젝트의 `README.md` 또는 원하는 파일에 후원 정보를 자동으로 기록해주는 서비스
</p>

---

## [fairydust.kr](https://fairydust.kr)
...
[이용약관](https://fairydust.kr/terms) | [데이터처리방침](https://fairydust.kr/privacy) | [라이선스](LICENSE)